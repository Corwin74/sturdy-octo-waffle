...
type Bootstrap struct {
	...
	Secrets       *Secrets               `protobuf:"bytes,3,opt,name=secrets,proto3" json:"secrets,omitempty"`
...
func (x *Bootstrap) GetSecrets() *Secrets {
	if x != nil {
		return x.Secrets
	}
	return nil
...
func (x *Secrets) GetJwtKey() string {
	if x != nil {
		return x.JwtKey
	}
	return ""
...
var file_conf_conf_proto_rawDesc = string([]byte{
	...
	0x07, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13,
	0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x73, 0x52, 0x07, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x22, 0xb8, 0x02, 0x0a,
	...
	0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x22, 0x0a, 0x07, 0x53, 0x65,
	0x63, 0x72, 0x65, 0x74, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x6a, 0x77, 0x74, 0x5f, 0x6b, 0x65, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6a, 0x77, 0x74, 0x4b, 0x65, 0x79, 0x42, 0x19,
	0x5a, 0x17, 0x73, 0x68, 0x6f, 0x70, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f,
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Secrets)(nil),             // 3: kratos.api.Secrets
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3, // 2: kratos.api.Bootstrap.secrets:type_name -> kratos.api.Secrets
